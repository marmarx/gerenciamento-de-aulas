...
const { finishEvent, initialUpdate, overlapWarning } = useEventDefaults(event)

watch(overlapWarning, (val) => { if (val) { toastShow('Eventos sobrepostos', 'Este evento está sobreposto a outro evento') } })

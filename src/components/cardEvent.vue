...
// button visibility
const showButtons = computed(() => student.value.address || student.value.meeting || student.value.student_phone || student.value.parent_phone)
...
<template v-if="!student?.paused">
  <div title="Editar aula" class="card" :class="{magic: isNow, partiallyVisible: showRestore}" @click="routeTo('/aula')">
    ...
    <div v-if="isToday || showButtons" class="btns">

...
import { studentStats } from '@/composables/panorama'
...
<template>
  <div v-if="studentStats.length">
    ...
    <p class="tac mt10">Clique em um aluno para ver o relatório.  Clique no cabeçalho para organizar.</p>
  </div>

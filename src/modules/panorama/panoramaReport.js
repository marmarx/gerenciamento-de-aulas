...
const listChargableLessons = () => {
  const ev = dataStore.data.config.canceledOnReport ? chargableInRange.value : doneInRange.value
...
const report = computed(() => {
  ...
  // const previousEv = dataStore.data.config.canceledOnReport ? dataStore.chargableEvents : dataStore.doneEvents

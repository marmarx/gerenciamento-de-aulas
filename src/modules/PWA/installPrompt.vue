...
import { deferredPrompt, isInstalled, installButtonVisible, isIOS, installApp, hideInstallButton } from "@/modules/PWA/installPWA.js"
...
.pwabtn{ gap: 5px; padding: 5px 10px; color: currentColor; cursor: pointer }
.pwaicon{
  width: 22px; height: 22px;
  background-size: cover; background-position: center; background-repeat: no-repeat;
}
.pwaicon.install {background-image:url('PWAinstall.svg')}
.pwaicon.info {background-image:url('PWAinfo.svg')}

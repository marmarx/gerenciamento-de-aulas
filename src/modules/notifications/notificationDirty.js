...
const processDirtyEvent = async (id) => {
  ...
  return notification
  // if (notification) await scheduleNotifications([notificationStore])  // schedules notifications one-by-one
}
...
const processDirtyBirthday = async (id) => {
  ...
  return notification
  // if(notification) await scheduleNotifications([notificationStore])
}
